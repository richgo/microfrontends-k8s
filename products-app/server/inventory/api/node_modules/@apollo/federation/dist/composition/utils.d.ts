...
export declare function findDirectivesOnNode(node: Maybe<TypeDefinitionNode | TypeExtensionNode | FieldDefinitionNode | SchemaDefinitionNode>, directiveName: string): DirectiveNode[];
