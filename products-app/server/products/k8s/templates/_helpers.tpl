...
{{ include "products-api.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "products-api.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "products-api.fullname" .) .Values.serviceAccount.name }}
{{- else }}
