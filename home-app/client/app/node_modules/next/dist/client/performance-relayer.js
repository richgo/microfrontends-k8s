...
type:'application/x-www-form-urlencoded'});const vitalsUrl='https://vitals.vercel-analytics.com/v1/vitals';navigator.sendBeacon&&navigator.sendBeacon(vitalsUrl,blob)||fetch(vitalsUrl,{body:blob,method:'POST',credentials:'omit',keepalive:true});}}var _default=onPerfEntry=>{// Update function if it changes:
